...
var _user$project$Bit$bitHighlighter = F2(
	function (bit, msg) {
		var _p2 = msg;
		if (_p2.ctor === 'MouseHover') {
			return _elm_lang$core$Native_Utils.update(
				bit,
				{
...
var _user$project$Bit$update = F2(
	function (msg, bit) {
		...
		switch (_p3.ctor) {
			...
			case 'MouseHover':
				return A2(_user$project$Bit$bitHighlighter, bit, msg);
			default:
				return bit;
		}
	});
...
var _user$project$Bit$ParityMouseClick = {ctor: 'ParityMouseClick'};
var _user$project$Bit$MouseHover = {ctor: 'MouseHover'};
var _user$project$Bit$Click = {ctor: 'Click'};
var _user$project$Bit$clickType = function (category) {
	var _p4 = category;
	switch (_p4) {
		case 'data':
			return _user$project$Bit$Click;
		case 'parity':
			return _user$project$Bit$ParityMouseClick;
		default:
			return _user$project$Bit$MouseHover;
	}
};
var _user$project$Bit$view = function (bit) {
	var clickEvent = _user$project$Bit$clickType(bit.category);
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onClick(clickEvent),
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$x(textOrigin),
						_elm_lang$svg$Svg_Attributes$y(textOrigin),
						_elm_lang$svg$Svg_Attributes$fill('black'),
						_elm_lang$svg$Svg_Attributes$fontFamily('monospace'),
						_elm_lang$svg$Svg_Attributes$fontSize(textOrigin),
...
var _user$project$HammingPacket$specificParityValue = F2(
	function (x, packet) {
...
var _user$project$HammingPacket$hammingParity = F2(
	function (x, packet) {
		var _p2 = A2(
					...
					A2(
						...
						_elm_lang$core$String$concat(
							A2(
								...
								A2(_user$project$HammingPacket$specificParityValue, x, packet)))))),
			2);
		switch (_p2) {
			case 0:
				return 0;
	...
	function (msg, packet) {
		...
		switch (_p3.ctor) {
			...
			case 'RemoveBit':
				...
				return (_elm_lang$core$Native_Utils.cmp(packet.n, 0) > 0) ? _elm_lang$core$Native_Utils.update(
					packet,
					{
			...
			case 'ModifyBit':
				...
				var updateSpecificBit = function (bit) {
					return _elm_lang$core$Native_Utils.eq(bit.position, _p5) ? A2(_user$project$Bit$update, _p4, bit) : (_elm_lang$core$Native_Utils.eq(
						Math.pow(
							2,
							_elm_lang$core$Basics$round(
								A2(
						...
						_p5) ? (_elm_lang$core$Native_Utils.eq(
						A2(
							_elm_lang$core$Maybe$withDefault,
							0,
							A2(
						...
						1) ? A2(_user$project$Bit$bitHighlighter, bit, _p4) : bit) : (A2(_user$project$HammingPacket$isParityBit, bit.position, _p5) ? A2(_user$project$Bit$update, _p4, bit) : bit));
				};
				return _elm_lang$core$Native_Utils.update(
					packet,
					{
...
var _user$project$HammingPacket$defaultPacket = {
	bits: _elm_lang$core$Native_List.fromArray(
		[
			A4(_user$project$Bit$defaultBit, 0, 7, 'data', false),
			A4(_user$project$Bit$defaultBit, 0, 6, 'data', false),
			A4(_user$project$Bit$defaultBit, 1, 5, 'data', false),
			A4(_user$project$Bit$defaultBit, 1, 4, 'parity', false),
			A4(_user$project$Bit$defaultBit, 0, 3, 'data', false),
			A4(_user$project$Bit$defaultBit, 0, 2, 'parity', false),
	...
	k: 3,
	status: 'T',
	seed: _elm_lang$core$Random$initialSeed(4)
};
var _user$project$HammingPacket$Model = F5(
	function (a, b, c, d, e) {
		return {bits: a, n: b, k: c, status: d, seed: e};
	});
...
var _user$project$HammingPacket$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _user$project$HammingPacket$defaultPacket, view: _user$project$HammingPacket$view, update: _user$project$HammingPacket$update})
};
...
var _user$project$Packet$dec2bin = function (v) {
	...
	switch (_p0) {
		...
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Packet$dec2bin((v / 2) | 0),
				_elm_lang$core$Basics$toString(
					A2(_elm_lang$core$Basics_ops['%'], v, 2)));
	}
};
var _user$project$Packet$allPossibleValues = function (n) {
	var padZeroes = function (binaryString) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				_elm_lang$core$String$repeat,
				n - _elm_lang$core$String$length(binaryString),
				'0'),
			binaryString);
	};
	var maxPossibleValue = Math.pow(2, n) - 1;
	var valueStrings = A2(
		_elm_lang$core$List$map,
		_user$project$Packet$dec2bin,
		_elm_lang$core$Native_List.range(0, maxPossibleValue));
...
var _user$project$Packet$Modify = F2(
	function (a, b) {
...
var _user$project$Main$corruptTheBit = F2(
	function (x, bit) {
		return _elm_lang$core$Native_Utils.eq(bit.position, x) ? _user$project$Bit$bitToggle(bit) : bit;
	});
var _user$project$Main$transmittedBits = F2(
	function (x, bits) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Main$corruptTheBit(x),
			bits);
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'PacketMsg':
				var updatedPacketModel = A2(_user$project$Packet$update, _p0._0, model.packetModel);
				return _elm_lang$core$Native_Utils.update(
					model,
					{packetModel: updatedPacketModel});
			case 'BitMsg':
				var updatedBitModel = A2(_user$project$Bit$update, _p0._0, model.bitModel);
				return _elm_lang$core$Native_Utils.update(
					model,
			...
			default:
				var rModel = model.hammingReceivedModel;
				var transmittedModel = model.hammingModel;
				var _p1 = A2(
					_elm_lang$core$Random$step,
					A2(_elm_lang$core$Random$int, 0, transmittedModel.n),
					rModel.seed);
...
var _user$project$Main$pluralString = F2(
	function (_p2, n) {
		var _p3 = _p2;
		return _elm_lang$core$Native_Utils.eq(n, 1) ? A2(_elm_lang$core$Basics_ops['++'], ' ', _p3._0) : A2(_elm_lang$core$Basics_ops['++'], ' ', _p3._1);
	});
var _user$project$Main$combinatricsNotation = F2(
	function (x, y) {
		return A2(
...
var _user$project$Main$singleParity = function (model) {
	var _p5 = A2(
		_elm_lang$core$Basics_ops['%'],
		_elm_lang$core$String$length(
			A2(
				...
				A2(
					...
					_elm_lang$core$String$concat(
						A2(
							_elm_lang$core$List$map,
							_elm_lang$core$Basics$toString,
							_user$project$Packet$packetValue(model.packetModel)))))),
		2);
	switch (_p5) {
		case 0:
			return model.oddeven;
		case 1:
			return A2(_elm_lang$core$Basics_ops['%'], model.oddeven + 1, 2);
		default:
			return 5;
	}
};
...
var _user$project$Main$singleErrorCorrection = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$Main$ToggleOddEven = {ctor: 'ToggleOddEven'};
var _user$project$Main$UpdateProbability = function (a) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Probability of Error')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$on,
								'change',
								A2(_elm_lang$core$Json_Decode$map, _user$project$Main$UpdateProbability, _elm_lang$html$Html_Events$targetValue))
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
...
var _user$project$Main$BitMsg = function (a) {
	return {ctor: 'BitMsg', _0: a};
};
var _user$project$Main$bitIntro = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('A Bit')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Let\'s start with the fundamental unit of communication: Binary Digit or a Bit. In English, we have 26 alphabets, 10 digits and several punctuation marks to store and exchange information. In computers, we have just 2. ')
					])),
				A2(
				_elm_lang$html$Html_App$map,
				_user$project$Main$BitMsg,
				_user$project$Bit$view(model.bitModel)),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Click anywhere within the green square to toggle its value between 0 and 1.')
					]))
			]));
};
var _user$project$Main$PacketMsg = function (a) {
	return {ctor: 'PacketMsg', _0: a};
};
var _user$project$Main$packetIntro = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('A Packet')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$parityIntro = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Single Error Detection')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'When, the receiver gets this packet. It knows that there must be ',
							A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Main$oddEven(model),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Main$tutorialIntroText,
						_user$project$Main$bitIntro(model),
						_user$project$Main$packetIntro(model),
